...
!(__WEBPACK_AMD_DEFINE_RESULT__ = function (require) {
    ...
    return function module() {
         ...
         * @public
         * @example
         *     line.xAxisFormat(line.axisTimeCombinations.MONTH_YEAR)
         */
         ...
         * @example
         *     line.xAxisCustomFormat(line.axisTimeCombinations.MONTH_YEAR)
         */
...
!(__WEBPACK_AMD_DEFINE_RESULT__ = function (require) {
    ...
    return function module() {
        ...
        function drawTooltip() {
            ...
            tooltip = tooltipTextContainer.append('rect').classed('tooltip-text-container', true).attr('x', -tooltipWidth / 4 + 5).attr('y', 0).attr('width', tooltipWidth).attr('height', tooltipHeight).attr('rx', tooltipBorderRadius).attr('ry', tooltipBorderRadius).style('fill', 'transparent').style('stroke', borderStrokeColor).style('stroke-width', 0);

            tooltipTitle = tooltipTextContainer.append('text').classed('tooltip-title', true).attr('x', -tooltipWidth / 4 + 16).attr('y', 16).style('fill', borderStrokeColor);

            tooltipDivider = tooltipTextContainer.append('line').classed('tooltip-divider', true).attr('x1', -tooltipWidth / 4 + 16).attr('x2', 265).attr('y1', 31).attr('y2', 31).style('stroke', 'transparent');
...
!(__WEBPACK_AMD_DEFINE_RESULT__ = function (require) {
    ...
    return function module() {
        ...
        function updateContent() {
            ...
            if (title) {
                tooltipTitle = tooltipTextContainer.append('text').classed('mini-tooltip-title', true).attr('y', 0).style('fill', titleFillColor).style('font-size', textSize).text(title);
